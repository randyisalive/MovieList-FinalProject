...
var classes = {
  ...
  menuitem: function menuitem(_ref2) {
    var item = _ref2.item, activeItemState = _ref2.activeItemState;
...
var MenubarSub = React.memo(React.forwardRef(function(props, ref) {
  var _React$useState = React.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), activeItemState = _React$useState2[0], setActiveItemState = _React$useState2[1];
  var ptm = props.ptm, cx = props.cx;
  var getPTOptions = function getPTOptions2(item, key) {
    return ptm(key, {
      props,
  ...
  var createSubmenu = function createSubmenu2(item, index) {
    if (item.items) {
  ...
  var createMenuitem = function createMenuitem2(item, index) {
    ...
    var submenuIcon = item.items && IconUtils.getJSXIcon(!props.root ? props.submenuIcon || React.createElement(AngleRightIcon, submenuIconProps) : props.submenuIcon || React.createElement(AngleDownIcon, submenuIconProps), _objectSpread$1({}, submenuIconProps), {
      props: _objectSpread$1({
        menuProps: props.menuProps
      }, props)
    });
    var submenu2 = createSubmenu(item, index);
    ...
    return React.createElement("li", menuitemProps, content, submenu2);
  };
