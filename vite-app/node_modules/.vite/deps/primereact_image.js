...
var useEventListener = function useEventListener2(_ref) {
  ...
  var listenerRef = React6.useRef(null);
...
var Image = React6.memo(React6.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React6.useState(false), _React$useState2 = _slicedToArray5(_React$useState, 2), maskVisibleState = _React$useState2[0], setMaskVisibleState = _React$useState2[1];
  var _React$useState3 = React6.useState(false), _React$useState4 = _slicedToArray5(_React$useState3, 2), previewVisibleState = _React$useState4[0], setPreviewVisibleState = _React$useState4[1];
  var _React$useState5 = React6.useState(0), _React$useState6 = _slicedToArray5(_React$useState5, 2), rotateState = _React$useState6[0], setRotateState = _React$useState6[1];
  var _React$useState7 = React6.useState(1), _React$useState8 = _slicedToArray5(_React$useState7, 2), scaleState = _React$useState8[0], setScaleState = _React$useState8[1];
  ...
  var previewClick = React6.useRef(false);
  ...
  var createPreview = function createPreview2() {
    ...
    if (props.preview) {
      return React6.createElement("div", buttonProps, content);
    }
    return null;
  };
